...
// const run0 = new Running([30, -10], 5.2, 47, 100)
// const cycl0 = new Cycling([30, -10], 10, 40, 150)
// console.log(run0, cycl0);
...
class App {
    ...
    _newowrkout(e) {
        ...
        //render workout on the sidenav
        this.renderWorkout(workout);

        // clear input / hide the form
        this.hideform();
